...
<div class="header">
	...
	<div class="flex items-center gap-5">
		<Text class="ml-5">Home</Text>
		<Text class="ml-5">About Us</Text>
		<Text class="ml-5">Our Team</Text>
		<Text class="ml-5">Sponsor</Text>
...
<div class="mb-16">
	...
	<div class="flex justify-center">
		<LargeText class="text-center w-5/6 mt-8"
			...
			local leaders. Together, let's create a buzzing new volunteer community!</LargeText
		>
	</div>
</div>
...
<div>
	...
	<div class="faq-item">
		<Section>What is Helper Hive</Section>
		<LargeText
			...
			spark your passion, whenever it suits you. Explore local opportunities, sign up effortlessly,
			and bring along your friends, family, and neighbors. Together, let’s BEE more involved and
			make a positive impact in our community! Visit our About Us page to learn more.</LargeText
		>
	</div>
	<div class="faq-item">
		<Section>Who can join?</Section>
		<LargeText
			...
			experience. By embracing diversity and inclusivity, we strive to create meaningful
			opportunities for all to engage in service and make a positive impact together.</LargeText
		>
	</div>
	<div class="faq-item">
		<Section>How do I join?</Section>
		<LargeText
			...
			to dive into your volunteering journey!</LargeText
		>
	</div>
	<div class="faq-item">
		<Section>Will my hours be recorded?</Section>
		<LargeText
			...
			on Helper Hive Network, as well as a detailed view by organization and event. This system
			ensures you have a clear and accurate record of all your volunteering activities.</LargeText
		>
	</div>
</div>
