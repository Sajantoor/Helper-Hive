...
<nav class="flex items-center justify-between p-4 bg-white text-black border-b-2 shadow-sm">
    ...
    <div class="profile-pic">
        <img src={profilePicSrc} alt="Profile Picture" class="h-10 w-10 rounded-full object-cover">
    </div>
</nav>