...
>
	<div class="flex items-center gap-10">
		...
		<div class="nav-links flex gap-14">
			...
			<a href="/app/events/create" class="text-black hover:underline"><Text>Create Event</Text></a>
		</div>
	</div>
		...
		{#if isDropdownOpen}
			<div class="dropdown-menu absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg z-10">
				<div class="p-4 flex items-center">
					...
					<div class="ml-3">
						<Text class="text-gray-900 font-semibold">Jessy Chahal</Text>
						<SmallText class="text-gray-600 text-sm truncate w-full">jessy@gmail.com</SmallText>
					</div>
				</div>
